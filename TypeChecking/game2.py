# game2.py: This is version two of game.py that makes the game more object
# oriented by encapsulating all the game logic in classes.
...
class Deck:
    ...
    def create(cls, shuffle: bool = False) -> "Deck":
        ...
        deck = [(s, r) for r in Card.RANKS for s in Card.SUITS]
        #   deck = []
        #   for r in RANKS:
        #       for s in SUITS:
        #           deck.append((s, r))
    ...
    def deal(self, num_hands: int) -> Tuple:
        """Deal the cards in the deck to a number of hands."""
        cls = self.__class__
...
class Game:
    def __init__(self, *names):
        """Set up the deck and deal cards to players."""
        deck = Deck.create(shuffle=True)
        # Code will generate a list of 4 names defaulting to P1, P2, P3 ...
